...
fields=["userId", "Name","Age","Location","Interests"]

# Generate users from userId 13 to 100
for user_id in range(102, 50001):
  # Randomly select first and last name
  first_name = random.choice(first_names)
  last_name = random.choice(last_names)
  
  # Generate a random age between 16 and 40
  age = random.randint(1, 40)
  
  # Randomly select a city
  city = random.choice(cities)
  
  # Randomly select 3 to 5 interests
